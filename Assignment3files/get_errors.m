function [] = get_errors(p_new, p_approx, p_correct, images)
    for i = 1 : 4
        ...
        disp('Sum err_reprojection between the new corner and approx corner is ');
        disp(sum_new_approx);
        disp('Average err_reprojection between the new corner and approx corner is ');
        disp(sum_new_approx / 80);
        disp('Sum err_reprojection between the new corner and correct corner is ');
        disp(sum_new_correct);
        disp('Average err_reprojection between the new corner and correct corner is ');
